...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = os.path.join(SCRIPT_DIR, "Output_Random_Forest")
    ...
    # ============================================================
    print("\n" + "=" * 60)
    print("STEP 7: All Features Will Be Used (RF selects on its own)")
    print("=" * 60)
    print(f"\n  Total feature count: {len(feature_cols)}")
    print(f"  No feature selection applied — Random Forest makes its own selection via feature_importance")
    ...
    ax.set_title(f"STEP 8 - Random Forest Feature Importance (Top {top_n} / {len(feature_cols)})",
                 fontweight="bold")
    ax.grid(True, alpha=0.3, axis="x")
    plt.tight_layout()
    ...
    result_path = os.path.join(OUTPUT_DIR, "Result_Random_Forest.csv")
    ...
    print(f"[CSV] Result_Random_Forest.csv saved")
