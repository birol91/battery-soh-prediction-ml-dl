"""
BMS Predictive Maintenance - GRU Pipeline
============================================
...
GRU processes sequences of cycles and can learn temporal patterns
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "Output_GRU")
...
if __name__ == "__main__":
    print("=" * 60)
    print("BMS Predictive Maintenance - GRU Pipeline")
    print("=" * 60)
    ...
    # ---- STEP 6: Feature Selection (All Features — GRU selects internally) ----
    print("\n" + "=" * 60)
    print("STEP 6: Feature Selection (All Features)")
    print("=" * 60)
    feature_cols = all_feature_cols  # Use all features — no manual selection
    print(f"  Total features: {len(feature_cols)}")
    print(f"  No manual selection — GRU handles feature importance via learned weights")
    ...
    # --- Result CSV ---
    result_path = os.path.join(OUTPUT_DIR, "Result_GRU.csv")
    ...
    print(f"[CSV] Result_GRU.csv saved")
