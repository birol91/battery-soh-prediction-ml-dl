"""
BMS Predictive Maintenance - LSTM Top30 Pipeline
==================================================
...
Unlike classical ML models (RF, XGBoost), LSTM processes sequences
...
8. LSTM model training (Baseline + Tuned)
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "Output_LSTM_Top30")
...
if __name__ == "__main__":
    print("=" * 60)
    print("BMS Predictive Maintenance - LSTM Top30 Pipeline")
    print("=" * 60)
    ...
    # --- Result CSV ---
    result_path = os.path.join(OUTPUT_DIR, "Result_LSTM_Top30.csv")
    ...
    print(f"[CSV] Result_LSTM_Top30.csv saved")
